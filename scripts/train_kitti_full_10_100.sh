...
python -m visdom.server -port 8070 &
python train.py \
--niter 10 \
--niter_decay 10 \
--display_port 8070 \
--batchSize 4 \
--gpu_ids 0 \
--name kitti_l1-100.0_com-r-10.0_com-s-10.0_cycle-1.0_lr-1e-5_cyclenet-20 \
--model commutative \
...
--init_R2S_netG_filename /gpfs/gpfs0/d.sungatullina/commutative_depth/init_models/20_net_G_B.pth \
--init_R2S_netD_filename /gpfs/gpfs0/d.sungatullina/commutative_depth/init_models/20_net_D_B.pth \
--init_S2R_netG_filename /gpfs/gpfs0/d.sungatullina/commutative_depth/init_models/20_net_G_A.pth \
--init_S2R_netD_filename /gpfs/gpfs0/d.sungatullina/commutative_depth/init_models/20_net_D_A.pth \
--com_loss usual \
