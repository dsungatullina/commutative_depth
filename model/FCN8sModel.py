...
class FCN8sModel(BaseModel):
    ...
    def supervised_loss(score, target, weight=None, size_average=True):
        print(target)
        n, c, h, w = score.size()
        ...
        loss = F.cross_entropy(
            score, target, weight=weight, size_average=size_average, ignore_index=255
        )
        return loss
    ...
    #     loss = F.cross_entropy(score, label, weight=weights, size_average=True, ignore_index=255)
    #     return loss
    ...
    def initialize(self, opt):
        ...
        self.loss_names = ['loss_lab_s', 'loss_lab_t']
    ...
    def backward_task(self):
        ...
        print(self.fake_lab_s.size(), self.lab_s.size())
        self.loss_lab_s = self.task_loss(self.fake_lab_s, self.lab_s)
    ...
    def validation_target(self):
        ...
        task_loss = self.task_loss(self.fake_lab_t, self.lab_t)
